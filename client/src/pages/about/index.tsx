...
export const About: React.FC = () => {
    return (
        <div className='mx-60'>
            ...
            <List>
                <li>Проипт — основной текстовый запрос, задаёт тему и стиль будущей иллюстрации.</li>
                <li>Отрицательный проипт — список нежелательных элементов, которых нужно избегать в картинке.</li>
                <li>
                    Шагов генерации — число итераций моделирования: больше шагов = более детализированный результат.
                </li>
                <li>
                    Коэффициент соответствия — коэффициент условного контроля: баланс между точным исполнением prompt и
                    творческой вариативностью модели.
                </li>
                <li>
                    Модель — алгоритм семплинга (DPMSolver, Euler, Heun и др.), влияющий на характер шума и гладкость
                    контура.
                </li>
            </List>
